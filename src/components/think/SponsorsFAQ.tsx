    ...
    <section className="py-32 bg-white text-black px-6">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-32">
          <h2 className="text-2xl font-semibold uppercase tracking-widest mb-16 opacity-40 italic">Proudly Partnered With</h2>
          <div className="flex flex-wrap justify-center items-center gap-16 md:gap-24 opacity-30 grayscale hover:grayscale-0 hover:opacity-100 transition-all duration-700">
             {sponsors.map((s, i) => (
               <div key={i} className="text-4xl font-semibold tracking-tighter select-none">{s}</div>
             ))}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
          <div>
            <h2 className="text-6xl font-semibold uppercase italic tracking-tighter mb-8">FAQ</h2>
          ...
          <div className="space-y-12">
            {faqs.map((faq, i) => (
              ...
              >
                <h3 className="text-2xl font-semibold mb-4 italic uppercase tracking-tight">{faq.q}</h3>
