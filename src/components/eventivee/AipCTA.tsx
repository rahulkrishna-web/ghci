...
export default function AipCTA({ data }: AipCTAProps) {
  return (
    <section className="py-20 md:py-32 bg-[#070708] text-white px-4 md:px-13 relative overflow-hidden">
      ...
      <div className="w-full max-w-4xl mx-auto text-center relative z-10">
        ...
        <motion.p
          ...
          className="text-white/70 text-lg md:text-2xl max-w-4xl mx-auto mb-12 leading-relaxed font-medium whitespace-pre-line"
        >
          {data.ctaSectionText}
        </motion.p>
