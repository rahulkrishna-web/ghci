        ...
        <div className="relative group">
          ...
          {canScrollLeft && (
            <motion.button
              ...
              onClick={() => scroll('left')}
              className="hidden md:block absolute left-4 md:left-8 top-1/2 -translate-y-1/2 z-30 p-4 rounded-full bg-black/40 backdrop-blur-md border border-white/10 hover:bg-[#A32482] transition-all group/btn cursor-pointer"
            >
          ...
          {canScrollRight && (
            <motion.button
              ...
              className="hidden md:block absolute right-4 md:right-8 top-1/2 -translate-y-1/2 z-30 p-4 rounded-full bg-black/40 backdrop-blur-md border border-white/10 hover:bg-[#A32482] transition-all group/btn cursor-pointer"
            >
