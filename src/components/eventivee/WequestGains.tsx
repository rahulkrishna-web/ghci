        ...
        <div className="relative group">
          ...
          {canScrollLeft && (
            <motion.button
              ...
              onClick={() => scroll('left')}
              className="hidden md:block absolute left-4 md:left-8 top-1/2 -translate-y-1/2 z-30 p-4 rounded-full bg-black/40 backdrop-blur-md border border-white/10 hover:bg-[#A32482] transition-all group/btn cursor-pointer animate-in fade-in zoom-in duration-200"
            >
          ...
          {canScrollRight && (
            <motion.button
              ...
              className="hidden md:block absolute right-4 md:right-8 top-1/2 -translate-y-1/2 z-30 p-4 rounded-full bg-black/40 backdrop-blur-md border border-white/10 hover:bg-[#A32482] transition-all group/btn cursor-pointer animate-in fade-in zoom-in duration-200"
            >
          ...
          <div 
            ref={scrollRef}
            className="flex w-full overflow-x-auto py-4 -my-4 overflow-y-hidden gap-6 snap-x snap-mandatory pb-8 md:pb-0 scrollbar-hide px-4 md:px-13 scroll-pl-4 md:scroll-pl-13 items-stretch"
          >
