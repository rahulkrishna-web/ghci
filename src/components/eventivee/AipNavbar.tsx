...
export default function AipNavbar() {
          ...
          <div className="hidden md:flex items-center gap-8">
            {navLinks.map((link) => (
              <a
                key={link.label}
                href={link.href}
                className="text-white hover:text-[#A32482] transition-colors text-[1rem] tracking-tight font-medium"
              >
                {link.label}
              </a>
            ))}
            ...
            >
              <div className="h-full w-full relative transition-transform duration-500 ease-in-out group-hover:-translate-y-full">
                  <div className="h-full w-full flex items-center justify-center px-6 shrink-0 font-semibold">
                      Register Now
                  </div>
                  <div className="h-full w-full flex items-center justify-center px-6 shrink-0 font-semibold">
                      Register Now
